...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->PortNameB->TextChanged += gcnew System::EventHandler(this, &FormMain::PortNameB_Changed);
			// 
			// PortNameA
			// 
			...
			this->PortNameA->TextChanged += gcnew System::EventHandler(this, &FormMain::PortNameA_Changed);
			// 
			// UsePortsClassB
			// 
			...
			this->UsePortsClassB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::UsePortsClassB_Changed);
			// 
			// UsePortsClassA
			// 
			...
			this->UsePortsClassA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::UsePortsClassA_Changed);
			// 
			// pinNameON
			// 
			...
			this->picturePinMap->MouseLeave += gcnew System::EventHandler(this, &FormMain::picturePinMap_MouseLeave);
			this->picturePinMap->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &FormMain::picturePinMap_MouseMove);
			this->picturePinMap->MouseDoubleClick += gcnew System::Windows::Forms::MouseEventHandler(this, &FormMain::picturePinMap_MouseDoubleClick);
			this->picturePinMap->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &FormMain::picturePinMap_MouseDown);
			this->picturePinMap->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &FormMain::picturePinMap_Paint);
			this->picturePinMap->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &FormMain::picturePinMap_MouseUp);
			// 
			// EmuBrB
			// 
			...
			this->EmuBrB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::EmuBrB_Changed);
			// 
			// EmuOverrunB
			// 
			...
			this->EmuOverrunB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::EmuOverrunB_Changed);
			// 
			// PlugInModeB
			// 
			...
			this->PlugInModeB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::PlugInModeB_Changed);
			// 
			// ExclusiveModeB
			// 
			...
			this->ExclusiveModeB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::ExclusiveModeB_Changed);
			// 
			// ExclusiveModeA
			// 
			...
			this->ExclusiveModeA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::ExclusiveModeA_Changed);
			// 
			// PlugInModeA
			// 
			...
			this->PlugInModeA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::PlugInModeA_Changed);
			// 
			// EmuOverrunA
			// 
			...
			this->EmuOverrunA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::EmuOverrunA_Changed);
			// 
			// EmuBrA
			// 
			...
			this->EmuBrA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::EmuBrA_Changed);
			// 
			// HiddenModeA
			// 
			...
			this->HiddenModeA->CheckedChanged += gcnew System::EventHandler(this, &FormMain::HiddenModeA_Changed);
			// 
			// HiddenModeB
			// 
			...
			this->HiddenModeB->CheckedChanged += gcnew System::EventHandler(this, &FormMain::HiddenModeB_Changed);
			// 
			// pinNameA_RX
			// 
			...
			this->pairList->AfterSelect += gcnew System::Windows::Forms::TreeViewEventHandler(this, &FormMain::pairsList_AfterSelect);
			this->pairList->BeforeSelect += gcnew System::Windows::Forms::TreeViewCancelEventHandler(this, &FormMain::pairsList_BeforeSelect);
			// 
			// buttonRemovePair
			// 
			...
			this->buttonRemovePair->Click += gcnew System::EventHandler(this, &FormMain::buttonRemovePair_Click);
			// 
			// buttonAddPair
			// 
			...
			this->buttonAddPair->Click += gcnew System::EventHandler(this, &FormMain::buttonAddPair_Click);
			// 
			// buttonApply
			// 
			...
			this->buttonApply->Click += gcnew System::EventHandler(this, &FormMain::buttonApply_Click);
			// 
			// buttonReset
			// 
			...
			this->buttonReset->Click += gcnew System::EventHandler(this, &FormMain::buttonReset_Click);
			// 
			// Form1
			// 
			...
			this->Name = L"Form1";
			this->Load += gcnew System::EventHandler(this, &FormMain::this_Load);
...
#define DeclareControlPairCheckBox(control) \
          ...
          void control##_Changed(int i) { \
            try { \
            if (pairList->SelectedNode == nullptr) return; \
	...
	private:
		...
		void PortName_GetChanges(int i, PortPair^ portChanges) {
			...
			String^ realportname = (gcnew String("RealPortName"))->ToLower();
			if (UsePortsClass_pair[i]->Checked) {
				if (checked) {
					if (name != value) {
						portChanges[i][realportname] = value;
					}
				}
				else {
...
#define ForEachControlPair(func) \
	...
	private:
		...
		Void Reset() {
			...
			for each (auto kvpPair in pairs) {
			...
			if (pairList->SelectedNode == nullptr && pairList->Nodes->Count > 0) {
				try {
