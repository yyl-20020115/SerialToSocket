...
class DevProperties {
  public:
    ...
    const TCHAR *DevId(const TCHAR *_pDevId);
    const TCHAR *PhObjName(const TCHAR *_pPhObjName);
    const TCHAR *Location(const TCHAR *_pLocation);

    const TCHAR *DevId() const { return pDevId; }
    const TCHAR *PhObjName() const { return pPhObjName; }
    const TCHAR *Location() const { return pLocation; }
...
///////////////////////////////////////////////////////////////
typedef bool CNC_ENUM_FILTER(const TCHAR *pHardwareId);
